        ...
        data() {
            return {
                ...
                url: "https://eu-west-1a.online.tableau.com/t/goldmedia/views/" +
                    "StandortmonitorV_1_7_TP/2_4UnternehmenSelbststndige?iframeSizedToWindow=true&:embed=y&Bundesland=&:display_count=no&:showAppBanner=false&:origin=viz_share_link&:showVizHome=no",
                options: {
                    hideTabs: true,
                    width: "100%",
                    height: "100%",
