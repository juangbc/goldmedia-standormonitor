<template>
    <div class="main-container">
        <navbar :mobile="mobile" :sidebar-collapsed="sidebarCollapsed"></navbar>
        <el-container class="pos-rel" :class="{'mobile': mobile}">
            <sidebar :mobile="mobile" v-show="!sidebarCollapsed.val"></sidebar>
            <el-main class="main" v-show="!sideBarVisibleMobile" :class="{'main-margin': !sidebarCollapsed.val}">
                <router-view/>
            </el-main>
        </el-container>
    </div>
